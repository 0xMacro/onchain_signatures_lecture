...
// taken from https://github.com/solidity-by-example/solidity-by-example.github.io
...
contract VerifySignature {
    ...
    */
    ...
    /* 5. Perform an action after correctly validating the signature
    ...
    */
    function sendETHWithValidSig(
        ...
        require(verify(_signer, _to, _amount, _message, _nonce, signature), "VerifySignature: INVALID_SIG");
